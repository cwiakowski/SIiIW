...
namespace AntColonySystem
{
    ...
    public class GreedyAlgorithm
    {
        ...
        private List<City> VisitedNodes { get; set; }
        private List<City> UnvisitedNodes { get; set; }
        ...
        public GreedyAlgorithm(Graph graph)
        {
            ...
            VisitedNodes = new List<City>();
            Path = new List<Edge>();
        }

        public double Run()
        {
            City toPoint, fromPoint;
            SetStartingPoint();
        ...
        private City ChooseNextPoint(City startPoint)
        {
            List<Edge> edges = new List<Edge>();

            foreach (City endPoint in UnvisitedNodes)
            {
        ...
        {
            City startPoint = Graph.Points.First(); // We can set any point as starting point. I choosed first one.
