...
namespace AntColonySystem
{
    public class Ant
    {
        ...
        public List<City> VisitedNodes { get; set; }
        public List<City> UnvisitedNodes { get; set; }
        ...
        private City Exploitation(Edge bestEdge)
        {
            return bestEdge.End;
        }

        private City Exploration(List<Edge> edgesWithWeight)
        {
            ...
            City choosenPoint = Helper.GetRandomEdge(cumSum);
