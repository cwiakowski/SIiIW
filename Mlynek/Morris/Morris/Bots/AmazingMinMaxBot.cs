...
{
    public class AmazingMinMaxBot : SimpleMinMaxBot
    {
        public AmazingMinMaxBot(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock) : base(playersState, playerType, ref movesTextBlock)
        {
            MaxDepth = 3;
        }

        public AmazingMinMaxBot(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock, int maxDepth, int maxTime) : base(playersState, playerType, ref movesTextBlock, maxDepth, maxTime)
        {
