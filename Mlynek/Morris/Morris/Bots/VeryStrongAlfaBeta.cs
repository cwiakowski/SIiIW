...
{
    public class VeryStrongAlfaBeta : SimpleAlfaBetaBot
    {
        public VeryStrongAlfaBeta(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock) : base(playersState, playerType, ref movesTextBlock)
        {
            MaxDepth = 3;
        }

        public VeryStrongAlfaBeta(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock, int maxDepth, int maxTime) : base(playersState, playerType, ref movesTextBlock, maxDepth, maxTime)
        {
