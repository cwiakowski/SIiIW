...
{
    public class HugeMinMaxBot : SimpleMinMaxBot
    {
        public HugeMinMaxBot(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock) : base(playersState, playerType, ref movesTextBlock)
        {
            MaxDepth = 3;
        }

        public HugeMinMaxBot(FieldState playersState, PlayerType playerType, ref TextBlock movesTextBlock, int maxDepth, int maxTime) : base(playersState, playerType, ref movesTextBlock, maxDepth, maxTime)
        {
